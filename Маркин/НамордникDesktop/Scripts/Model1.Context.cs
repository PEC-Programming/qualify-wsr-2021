...
namespace НамордникDesktop.Scripts
{
    ...
    public partial class wsruser3Entities : DbContext
    {
        public wsruser3Entities()
            : base("name=wsruser3Entities")
        {
        }
        ...
        public virtual DbSet<MaterialView> MaterialView { get; set; }
